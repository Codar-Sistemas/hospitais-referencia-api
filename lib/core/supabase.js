...
// Upsert with merge: existing row gets overwritten by the new payload.
// Required when re-running an expensive lookup (e.g. CEP-with-coords) to
// replace a stale cache entry that had nulls.
