...
> Plataforma pública que organiza, normaliza e republica os dados oficiais do Ministério da Saúde sobre os estabelecimentos habilitados pelo SUS. Dados atualizados todos os dias. Custo zero, gratuito, sem cadastro. A primeira vertical em produção cobre acidentes por animais peçonhentos (cobras, escorpiões, aranhas, lagartas); doenças raras e oncologia estão em construção.
...
- [Hub MapaSUS](${SITE}/): porta de entrada da plataforma, lista as verticais disponíveis
- [Animais peçonhentos — busca por cidade, CEP ou animal](${SITE}/venomous-animals): formulário principal para o público geral
- [Animais peçonhentos — consulta para profissionais](${SITE}/venomous-animals/profissionais): tabela técnica com CNES, telefone, grade completa de soros e mapa
...
- [GET /v1/venomous-animals/hospitals](${API}/v1/venomous-animals/hospitals): busca por state_code, city, treatment, q
- [GET /v1/venomous-animals/hospitals/nearby](${API}/v1/venomous-animals/hospitals/nearby): busca por proximidade (cep, lat+lng ou city)
