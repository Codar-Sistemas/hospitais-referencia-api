...
export const alt =
  'Hospitais de Referência — Soro antiofídico e antiveneno no Brasil. Dados oficiais do Ministério da Saúde.';
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Hospitais com soro antiofídico e antiveneno no Brasil
          </div>
          <div
            style={{
              marginTop: 28,
          ...
          >
            Encontre a unidade de referência mais próxima em caso de acidente com animais
            peçonhentos.
          </div>
        </div>
