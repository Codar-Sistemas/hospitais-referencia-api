...
export default function SamuBadge({ className = 'flex' }: { className?: string }) {
  return (
    <a
      href="tel:192"
      className={`${className} items-center gap-1.5 whitespace-nowrap text-xs font-semibold text-red-600 bg-red-50 border border-red-200 px-3 py-1.5 rounded-full hover:bg-red-100 transition-colors`}
    >
